...
abstract class MongoQueryBuilder implements Builder
{
    protected $builder;
    protected $columns;
    ...
    public function whereColumn($first, null|string $operator = null, $second = null, $boolean = 'and')
    {
    ...
    public function whereJsonContains($column, $values, $boolean = 'and', $not = false)
    {
